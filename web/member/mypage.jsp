        ...
        <div>
            ...
            <div class="session1 p-3 mb-2">
                <div class="fs-3 border-bottom">
                    <span class="fw-bold"><%=m.getNickname()%>님</span>
                    반가워요!
                </div>
                <div>
                    <ul class="list-group list-group-flush">
                        <h4>아이디</h4>
                        <li class="list-group-item"><%=m.getUsername()%>
                        </li>
                        <h4>닉네임</h4>
                        <li class="list-group-item"><%=m.getNickname()%>
                        </li>
                        <h4>이메일</h4>
                        <li class="list-group-item"><%=m.getEmail()%>
                        </li>
                        <div class="levelInfo">
                            <h4>회원 등급</h4>
                        ...
                        <li class="list-group-item border-bottom"><%=m.getLevel()%>
                        </li>
                    </ul>
                </div>
            </div>
