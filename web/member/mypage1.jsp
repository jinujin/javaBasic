        ...
        <div>
            ...
            <div class="session1 p-3 mb-2">
                <div class="fs-3 border-bottom">
                    <c:set var="m" value="<%=m%>"/>
                    <span class="fw-bold">${m.nickname}님</span>
                    반가워요!
                </div>
                <div>
                    <ul class="list-group list-group-flush">
                        <h4>아이디</h4>
                        <li class="list-group-item">${m.username}
                        </li>
                        <h4>닉네임</h4>
                        <li class="list-group-item">${m.nickname}
                        </li>
                        <h4>이메일</h4>
                        <li class="list-group-item">${m.email}
                        </li>
                        <div class="levelInfo">
                            <h4>회원 등급</h4>
                            <botton class="btn btn-outline-secondary tooltip">
                                등급정보
                                <span class="tooltiptext">
                                    1. 일반 회원<br>2. 평론가<br>3. 관리자
                                </span>
                            </botton>
                        </div>
                        <li class="list-group-item border-bottom">${m.level}
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="button">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <button type="button" class="btn btn-outline-success btn-sm" onclick="rankUp(${m.id})">등업 신청
                        </button>
                    </c:otherwise>
                </c:choose>
                ...
                <button type="button" class="btn btn-success"
                        onclick="location.href='/member/update.jsp?id=${m.id}'">수정하기
                </button>
            </div>
        </div>
    </main>
